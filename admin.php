...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Welcome</span>&nbsp;Naeem</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> Naeem <span class="caret"></span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="candidate_update.php"><span class="glyphicon glyphicon-stats"></span> Requests </a></li>
			<li><a href="nomination_form.php"><span class="glyphicon glyphicon-th"></span> Nomination </a></li>
			
			<li><a href="election.php"><span class="glyphicon glyphicon-list-alt"></span> Tables</a></li>
